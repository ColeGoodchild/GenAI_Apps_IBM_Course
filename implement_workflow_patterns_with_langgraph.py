...
Original file is located at
    https://colab.research.google.com/drive/13rTkJzeOw46hL7-JMK9rk47_jlAG7lEo
...
class Router(BaseModel):
    role: str = Field(
        ...,
        description="Classify the user request. Return exactly one of: 'ride_hailing_call', 'restaurant_order', 'groceries' and if you do not know the output 'default_handler'"
    )
