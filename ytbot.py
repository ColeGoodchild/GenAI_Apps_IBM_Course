...
def summarize_video(video_url):
    ...
    try:
        # Fetch and preprocess the transcript here
        fetched_transcript = fetch_transcript(video_url)
        processed_transcript = preprocess_transcript(fetched_transcript)
...
with gr.Blocks() as interface:
    ...
    summarize_btn.click(summarize_video, inputs=video_url, outputs=summary_output, transcript_status)
